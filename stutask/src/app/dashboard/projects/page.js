      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="space-y-6">
          <div className="flex flex-col items-start gap-2">
            ...
            <h1 className="text-2xl font-semibold">My <span className="text-blue-600">Projects</span></h1>
            <p className="text-sm text-gray-600">Confirmed hires you're working on.</p>
          </div>
        ...
        {!loading && items.length === 0 && (
          <div className="border rounded-2xl p-6 text-gray-600">No active projects yet.</div>
        )}
            ...
            <div key={app.id} className="border rounded-2xl p-5 flex flex-col md:flex-row md:items-center md:justify-between gap-3">
              ...
              <div className="space-y-1 text-sm text-gray-700">
                ...
                <div className="text-sm text-gray-900">
                  {app.payout?.amount ? formatCurrency(app.payout) : "Not set"}
                </div>
              </div>
